...
namespace BibleVerseApp.Data
{
     ...
     * CST-247
     * 
     * <summary>This is an interface to have all business services confide to a certian format for dependecy injection</summary>
     */
    public interface VerseBusinessInterface
    {
        /**
         * VerseBusinessInterface.Insert
         * <summary>Method inorder to pass a verse from the controller to the data service</summary>
         * 
        ...
        */
        ...
        /**
         * VerseBusinessInterface.GetById
         * <summary>Method to grab a specific verse by ID</summary>
         * 
